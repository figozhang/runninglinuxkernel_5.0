...
static int sctp_hash_cmp(struct rhashtable_compare_arg *arg,
				const void *ptr)
{
...
static __u32 sctp_hash_obj(const void *data, u32 len, u32 seed)
{
...
static __u32 sctp_hash_key(const void *data, u32 len, u32 seed)
{
