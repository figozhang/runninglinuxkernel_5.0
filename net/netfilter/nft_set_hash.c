...
static u32 nft_rhash_key(const void *data, u32 len, u32 seed)
{
...
static u32 nft_rhash_obj(const void *data, u32 len, u32 seed)
{
...
static int nft_rhash_cmp(struct rhashtable_compare_arg *arg,
				const void *ptr)
{
