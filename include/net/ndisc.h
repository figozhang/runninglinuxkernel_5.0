...
static u8 *__ndisc_opt_addr_data(struct nd_opt_hdr *p,
...
static u32 ndisc_hashfn(const void *pkey, const struct net_device *dev, __u32 *hash_rnd)
{
	const u32 *p32 = pkey;
...
static struct neighbour *__ipv6_neigh_lookup_noref(struct net_device *dev, const void *pkey)
{
